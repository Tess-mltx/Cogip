...
<body class="grid grid-cols-5 grid-rows-3 min-h-screen">
    <header class="flex flex-col h-full col-start-1 col-end-2 row-start-1 row-end-4 justify-around items-center w-64 fixed top-0 left-0 h-full">
        ...
        <nav class="flex-1">
            <ul class="mt-2">
                <li class="flex items-center py-2"><i class='bx bxs-dashboard'></i><a
                        class="px-2 text-xl capitalize hover:text-white transition duration-200 text-white tracking-wider font-bold"
                        href="#">dashboard</a></li>
                <li class="flex items-center py-2"><i class='bx bxs-notepad'></i><a
                        class="px-2 text-xl capitalize hover:text-white transition duration-200 tracking-wider font-bold"
                        href="#">invoices</a></li>
                <li class="flex items-center py-2"><i class='bx bxs-business'></i><a
                        class="px-2 text-xl capitalize hover:text-white transition duration-200 tracking-wider font-bold"
                        href="#">companies</a></li>
                <li class="flex items-center py-2"><i class='bx bxs-contact'></i><a
                        class="px-2 text-xl capitalize hover:text-white transition duration-200 tracking-wider font-bold"
                        href="#">contacts</a></li>
            </ul>
        </nav>
        <div class="flex justify-between items-center p-3 w-full">
            ...
            <div>
                <a class="font-bold p-3 tracking-widest capitalize hover:text-white transition duration-200"
                    href="#">logout</a>
            </div>
        </div>
    </header>
    <main class="overflow-y-auto grid row-span-3 col-span-4 absolute inset-y-0 inset-x-0 py-4 ml-64">
        <div class="flex w-full justify-around max-h-72 my-4 pr-12">
            <div class="flex flex-col justify-around">
                ...
                <div
                    class="container_welcome text-center flex flex-col items-center justify-center border border-white text-white">
        ...
        <div class="mx-10">
            ...
            <tbody>
                ...
                <div
                    class=" container_information col-span-1 row-span-1 border h-96 rounded-3xl w-11/12 cursor-pointer">
                    <div class="flex flex-col items-center my-10">
