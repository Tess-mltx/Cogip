    ...
    <footer class="bg-primary-color-orange w-full h-543 flex justify-center items-center">
        <div class="bg-black w-8/12 h-2/3 border-t-2 flex justify-center items-center flex-col">
